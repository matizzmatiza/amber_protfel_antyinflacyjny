...
function App() {
  ...
  const { ref, inView } = useInView({
    triggerOnce: true, // animacja odpali się tylko raz
      ...
      <div>
          ...
          <div className='payFor_sectionWrapper'>
            <div className='payFor_grid'>
              ...
              <div className='payFor_gridItem'>
                ...
                <a className='payFor_sectionLink' href="https://amerbroker.pl" target="blank">
                Sprawdź wyniki
                </a>
              </div>
            </div>
        ...
        <section className='order_section'>
          <div className='order_sectionWrapper'>
            ...
            <div className="what_line" style={{marginTop:'20px'}}>
        ...
        <section className='invest_section'>
          <div className='invest_sectionWrapper'>
            ...
            <div className='invest_gridOne'>
              <div className='invest_gridItem' ref={ref}>
                ...
                <div className='invest_gridItem_progressWrap'>
                    <div className="progress-bar">
                        <div className={`progress ${inView ? 'animate' : ''}`}>Portfel</div>
                    </div>
                </div>
              </div>
              <div className='invest_gridItem'>
                ...
                <div className='invest_gridItem_progressWrap'>
                    <div className="progress-bar">
                        <div className={`progress ${inView ? 'animate' : ''}`} style={{ width: inView ? '100%' : '0%' }}>Praktyczne raporty WIG20</div>
                    </div>
                </div>
              </div>
            </div>
            ...
            <div className='invest_gridItem' ref={ref}>
                ...
                <div className='invest_gridItem_progressWrap2'>
                    <div className="progress-bar">
                        <div className={`progress ${inView ? 'animate' : ''}`} style={{ width: inView ? '100%' : '0%' }}>Sygnały kupna/sprzedaży dla kontraktów na indeks WIG20</div>
                    </div>
                </div>
              </div>
              <div className='invest_gridItem' ref={ref}>
                ...
                <div className='invest_gridItem_progressWrap2'>
                    <div className="progress-bar">
                        <div className={`progress ${inView ? 'animate' : ''}`}>Graphic</div>
                    </div>
                </div>
              </div>
              <div className='invest_gridItem' ref={ref}>
                ...
                <div className='invest_gridItem_progressWrap2'>
                    <div className="progress-bar">
                        <div className={`progress ${inView ? 'animate' : ''}`}>Marketing
                        </div>
                    </div>
                </div>
              </div>
            </div>
            <div className='invest_lastItem' ref={ref}>
                ...
                <div className='invest_gridItem_progressWrap3'>
                    <div className="progress-bar">
                        <div className={`progress ${inView ? 'animate' : ''}`} style={{ width: inView ? '100%' : '0%' }}>włącz je, aby być stale na bieżąco</div>
                    </div>
                </div>
              </div>
          </div>
        ...
        <section className='footer'>
          <div className='footer_wrap'>
            <p>Copyright © 2022 Portfel Antyinflacyjny</p>
